...
const Machines: Machine[] = [
    {
        "name": "Turing Machine",
        "description": "A theoretical computing machine that manipulates symbols on a tape according to a set of rules.",
    ...
    },
    {
        ...
        "description": "A theoretical computing machine that manipulates symbols on a tape according to a set of rules. It is a variation of the original Turing Machine, introduced by Emil Post in 1936.",
        "inventor": "Emil Post",
        "year": 1936,
        "applications": [
        "Mathematical logic",
